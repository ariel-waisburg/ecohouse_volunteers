...
pie_turno = ggplot(data_voluntarios_3_new, aes(x = "",fill = Estado)) +
  geom_bar(width = 1, stat = "count", alpha = 0.8) +
  coord_polar(theta = "y") +
...
```{r}
graphedad = ggplot(data_voluntarios_2_new, aes(x = Edad)) +
...
mosaicplot(table(data_voluntarios_3_new$`Dias Semanales`, data_voluntarios_3$Estado), color = TRUE)
```
